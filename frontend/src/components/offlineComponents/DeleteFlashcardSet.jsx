...
export default function DeleteFlashcardSet({ id }) {
    ...
    useEffect(() => {
        const fetchFlashcardSet = async () => {
            try {
                ...
                console.error('Error fetchin flashcard set:', error);
    ...
    const handleDelete = () => {
        try {
            deleteDownloadedFlashcardSet(id);
            closeOverlay();
    ...
    return (
        <div className="flex flex-col w-80">
            <h1 className="text-3xl mb-4 text-center">Delete Offline Flashcard Set</h1>
            ...
            <div className="flex flex-row w-full">
                <button onClick={handleDelete} className="bg-red-500 hover:bg-red-600 py-2 px-6 rounded-lg mr-2 w-[calc(50%)]">Delete</button>
